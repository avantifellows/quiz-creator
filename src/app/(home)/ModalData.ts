...
export const displayData = (
  ...
  const activityDetails: DataSection = {
    title: 'Activity',
    data: [
      {
        label: 'Created By',
        value: data.meta_data?.created_by,
        preserveCase: true,
      },
      {
        label: 'Last Edited By',
        value: data.meta_data?.last_edited_by,
        preserveCase: true,
      },
      {
        label: 'Last Edited At',
        value: data.meta_data?.last_edited_at
          ? format(new Date(data.meta_data.last_edited_at), 'PPp')
          : undefined,
      },
      {
        label: 'Last Regenerated By',
        value: data.meta_data?.last_regenerated_by,
        preserveCase: true,
      },
      {
        label: 'Last Regenerated At',
        value: data.meta_data?.last_regenerated_at
          ? format(new Date(data.meta_data.last_regenerated_at), 'PPp')
          : undefined,
      },
  ...
  const showingData: DataSection[] = [
    ...
    timeDetails,
    activityDetails.data.length ? activityDetails : null,
